...
export default function DOMDocument() {
  return (
    <div>
      <h2>Document</h2>
      <p>
        The <code>document</code> interface represents any web page loaded in the browser and serves
        as an entry point into the web page's content.
      </p>
      <p>It provides methods for accessing and manipulating the document's content.</p>
      <DOMDocumentMethods />
    </div>
  );
}
